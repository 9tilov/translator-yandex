 ...
 * Было принято решение использовать библиотеку Retrofit, а не
 * AsyncTask так как она позволяет удобно работать с ответами сервера
 * В данном случае ответ представляется в виде объекта, что значительно
