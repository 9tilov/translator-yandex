...
public class Consts {
    ...
    /**
     * тэг для фрагмента {@link com.moggot.mytranslator.fragments.TranslatorFragment}
     */
    public static final String TAG_FRAGMENT_TRANSLATOR = "tag_fragment_translator";

    /**
     * тэг для фрагмента {@link com.moggot.mytranslator.fragments.HistoryListFragment}
     */
